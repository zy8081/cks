...
void draw_pro_origin(void)
{
	...
	puthz3(250,120,32,32,1,"尊敬的火星开拓者，欢迎来到火星家园建设系统！");
	puthz3(250,160,32,32,1,"你将在这里模拟在火星建造建筑，研究科技。");
	puthz3(250,200,32,32,1,"请点击上面五个功能按键，进入操作界面");
	puthz3(250,240,32,32,1,"地图按钮：查看地图上的建筑和地形");
	puthz3(250,280,32,32,1,"资源按钮：查看你的资源和向地球申请资源援助");
	puthz3(250,320,32,32,1,"建造按钮：在地图上建造建筑");
	puthz3(250,360,32,32,1,"科技按钮：研究火星科技，获得更好的家园建设效果");
	puthz3(250,400,32,32,1,"时间按钮：包括让时间流动，保存，退出，查看日志的综合性按钮");

	puthz3(250,480,32,32,1,"如果有操作无法理解，可点击“说明文档”子按钮查看说明书");
