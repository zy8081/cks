...
void drawworkbar(char*path,int n,int form)
{
    ...
    {
        case OlymMon:
            put_hz24(420,160+(n-1)*120,"奥林匹斯山",65535,"C:\\TEST\\HZK\\HZK24",0);
            break;
        case MariVal:
            put_hz24(420,160+(n-1)*120,"水手大峡谷",65535,"C:\\TEST\\HZK\\HZK24",0);
            break;
        case ArabTer:
            put_hz24(420,160+(n-1)*120,"阿拉伯高地",65535,"C:\\TEST\\HZK\\HZK24",0);
            break;
        case UtopPla:
            put_hz24(420,160+(n-1)*120,"乌托邦平原",65535,"C:\\TEST\\HZK\\HZK24",0);
            break;
        case ElysPla:
